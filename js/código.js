...
function elección(númeroElegido) {
  ...
  if (númeroElegido == 1) {
    ...
    resultado =
      "una opción incorrecta. Por favor selecciona un número del 1 al 3.";
  }
...
while (triunfos < 3 && derrotas < 3) {
  elecciónJugador = prompt(
    "Escribe 1 para elegir piedra, 2 para elegir papel o 3 para elegir tijera."
  );
...
alert(
  "Número de veces que ganaste: " +
    triunfos +
    ". Número de veces que perdiste: " +
    derrotas +
    "."
);
